...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final KandyLibraryAccessors laccForKandyLibraryAccessors = new KandyLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>kandy</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public KandyLibraryAccessors getKandy() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForKandyLibraryAccessors;
    }
    ...
    public static class AndroidxSqliteLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>framework</b> with <b>androidx.sqlite:sqlite-framework</b> coordinates and
         * with version reference <b>sqlite</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getFramework() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.sqlite.framework");
        }
     ...
     */
    @Deprecated
    public static class KandyLibraryAccessors extends SubDependencyFactory {
        private final KandyLetsLibraryAccessors laccForKandyLetsLibraryAccessors = new KandyLetsLibraryAccessors(owner);

        public KandyLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>kandy.lets</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KandyLetsLibraryAccessors getLets() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKandyLetsLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KandyLetsLibraryAccessors extends SubDependencyFactory {

        public KandyLetsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>plot</b> with <b>org.jetbrains.kotlinx:kandy-lets-plot</b> coordinates and
         * with version reference <b>kandyLetsPlot</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hiltAndroid</b> with value <b>2.56.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kandyLetsPlot</b> with value <b>0.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKandyLetsPlot() { return getVersion("kandyLetsPlot"); }
        ...
        /**
         * Version alias <b>ksp</b> with value <b>2.1.20-1.0.32</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class HiltPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>hilt.dagger</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>hiltAndroid</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getDagger() { return createPlugin("hilt.dagger"); }
